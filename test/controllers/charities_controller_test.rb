...
class CharitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create charity" do
    assert_difference('Charity.count') do
      post charities_url, params: { charity: { charity_id: @charity.charity_id, email: @charity.email, name: @charity.name, password_digest: @charity.password_digest } }
    end
  ...
  test "should update charity" do
    patch charity_url(@charity), params: { charity: { charity_id: @charity.charity_id, email: @charity.email, name: @charity.name, password_digest: @charity.password_digest } }
